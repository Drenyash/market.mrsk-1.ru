...
module.exports = [
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/rent_backup.html",
    filename: "rent_backup.html",
    inject: "body",
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/rent-detail_backup.html",
    filename: "rent-detail_backup.html",
    inject: "body",
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/business-rsac.html",
    filename: "business-rsac.html",
    inject: "body",
    title: "Услуги бизнес-аналитики",
    head,
    sectionHeader,
    breadcrumbs,
    sectionFooter,
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/business-decision.html",
    filename: "business-decision.html",
    inject: "body",
    title: "Услуги бизнес-аналитики",
    head,
    sectionHeader,
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/business-customer.html",
  ...
  new HtmlWebpackPlugin({
    template: "./src/pages/business-contacts.html",
    filename: "business-contacts.html",
    inject: "body",
    title: "Услуги бизнес-аналитики",
    head,
    sectionHeader,
